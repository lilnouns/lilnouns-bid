...
const navigation: any[] = [
  ...
  {
    name: 'Twitter',
    href: 'https://twitter.com/nekofar',
    icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
...
export const Footer = ({}: Props) => {
  return (
    <footer className="tw-bg-gray-100">
      <div className="tw-mx-auto tw-max-w-7xl tw-px-4 tw-py-12 sm:tw-px-6 md:tw-flex md:tw-items-center md:tw-justify-between lg:tw-px-8">
        ...
        <div className="tw-mt-8 md:tw-order-1 md:tw-mt-0">
          <p className="tw-text-center tw-text-base tw-text-gray-400">
            &copy; 2022 Lil Nouns. No rights reserved.
          </p>
        </div>
      </div>
    </footer>
